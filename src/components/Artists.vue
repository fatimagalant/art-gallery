<template>
  ...
  <section id="artists-intro">
    <div id="intro">
      ...
      <div class="container">
        <p class="intro">Les Chévres represents artists whose</p>
        <p class="intro">deep connection to nature serves as</p>
        <p class="intro">their primary source of inspiration.</p>
      </div>
    </div>
  </section>
  <section id="Artists">

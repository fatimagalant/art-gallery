<template>
  <section id="contact">
    ...
    <div class="row">
      <div class="col-6">
        <form action="https://formspree.io/f/xoqropev" method="POST">
          <input
            name="name"
            type="text"
  ...
  <footer class="bg-black">
    ...
    <ul class="social-media-list">
      ...
      <li>
        <a href="https://twitter.com/" target="_blank" class="contact-icon">
